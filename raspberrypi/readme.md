The `gps.js` script is a Node.js program that reads GPS data from a GPS sensor connected to a Raspberry Pi's GPIO pins, and stores the data in a MySQL database.
